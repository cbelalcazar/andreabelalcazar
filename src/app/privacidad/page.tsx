...
export default function PrivacidadPage() {
  return (
    <main id="contenido" className="px-4 pt-32 pb-20 md:px-8">
      <article className="mx-auto max-w-2xl space-y-8 text-base leading-relaxed text-paper/90">
        <header>
          <p className="eyebrow mb-3">Legal</p>
          <h1 className="font-serif text-4xl text-balance text-white md:text-5xl">Política de privacidad</h1>
          <p className="mt-3 text-sm text-muted">Última actualización: 12 de septiembre de 2026.</p>
        </header>

        <section className="space-y-3">
          <h2 className="font-serif text-2xl text-white">Responsable</h2>
          <p>
            {site.name}, {site.city}, Colombia. Contacto:{" "}
            <a href={`mailto:${site.email}`} className="underline underline-offset-4 hover:text-gold">
              {site.email}
            </a>
            .
          </p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-2xl text-white">Qué datos se tratan</h2>
          <ul className="list-disc space-y-2 pl-5">
            <li>
              <strong className="text-white">Medición sin cookies.</strong> Vercel Analytics y Speed Insights registran
              páginas vistas y métricas de rendimiento de forma agregada, sin identificadores persistentes.
            </li>
            <li>
              <strong className="text-white">Google Analytics 4 (solo con tu consentimiento).</strong> Si aceptas el
            ...
            <li>
              <strong className="text-white">WhatsApp y correo.</strong> Si me escribes, trato los datos que tú incluyas
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-2xl text-white">Finalidad y base legal</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="font-serif text-2xl text-white">Tus derechos</h2>
          <p>
        ...
        <p className="pt-4 text-sm text-muted">
          <Link href="/" className="underline underline-offset-4 hover:text-gold">
            Volver al inicio
          </Link>
        </p>
      </article>
